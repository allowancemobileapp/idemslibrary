...
import { BookUser, FileText, ShoppingCart, CheckCircle2 } from 'lucide-react';
    ...
    const handlePayment = (values: z.infer<typeof formSchema>) => {
        ...
        if (window.FlutterwaveCheckout) {
            ...
            window.FlutterwaveCheckout({
                ...
                customizations: {
                    title: "Idem Library",
                    description: "Purchase: Introduction to Legal Practice",
                            ...
                            <Card className="sticky top-24">
                                ...
                                <CardContent className="p-6">
                                    ...
                                    <Dialog open={open} onOpenChange={setOpen}>
                                        ...
                                        <DialogContent>
                                            <DialogHeader>
                                                <DialogTitle>{paymentSuccess ? 'Payment Confirmed' : 'Complete Purchase'}</DialogTitle>
                                                <DialogDescription>
                                                    {paymentSuccess 
                                                        ? 'Thank you! Redirecting you to WhatsApp to coordinate delivery.' 
                                                        : 'Please provide your details to pay N15,000 via Flutterwave.'}
                                                </DialogDescription>
                                            </DialogHeader>
                                                    ...
                                                    <ul className="list-disc pl-6 space-y-1">
                                                     ...
                                                     <h4 className="font-bold text-foreground pt-4">CHAPTER SEVEN: Ethics and Professional Discipline of Legal Practitioners</h4>
                                                      ...
                                                      <ul className="list-disc pl-6 space-y-1">
                                                        ...
                                                        <li>Advantages of Doctrinal or Library-Based Research</li>
                                                        <li>Limitations of Doctrinal or Library-Based Research</li>
                                                        <li>Non-Doctrinal or Empirical Legal Research</li>
                                                        <li>Advantages of Non-Doctrinal or Empirical Legal Research</li>
                                                        <li>Disadvantages of Non-Doctrinal or Empirical Legal Research</li>
